$(document).ready(function() {
    ...
    // Gordon stop looking at my code, I already know it's gross.
    ...
    function init() {
        ...
        // bounding box
        var help = new THREE.BoxHelper(new THREE.Mesh(new THREE.BoxGeometry(settings.boundsSize, settings.boundsSize, settings.boundsSize), new THREE.MeshBasicMaterial({wireframe: true})));
